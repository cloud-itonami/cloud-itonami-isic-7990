# Operator Quickstart — Other reservation service and related activities

Shortest path from clone to a verified local dry-run for **ISIC 7990** (`cloud-itonami-isic-7990`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7990.git
cd cloud-itonami-isic-7990
```
...
- Blueprint governor key: `reservation-governor`
- Likely source path: `reservationops.governor.cljc`
